...
exports.xSearchTimelineByTop = async function (req) {
    const xData = {}
    ...
    const rawQuery = `${req.query.queryStr} until:${req.query.endTimeStr} since:${req.query.startTimeStr}`
    console.log(`rawQuery from IP ${req.ip.toString()}`,rawQuery)
    const variables = {"rawQuery":rawQuery,"count":20,"cursor":req.cursor,"querySource":"typed_query","product":"Top"}
    const features = {
