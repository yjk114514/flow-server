...
exports.xSearchProfile = async function (req) {
    ...
    const rawQuery = req.query.rawQuery ? req.query.rawQuery : `${req.query.screenName} until:${req.query.endTimeStr} since:${req.query.startTimeStr}`
